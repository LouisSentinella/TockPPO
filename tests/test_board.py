...
class TestBoard(unittest.TestCase):
    ...
    def test_backward_wrap(self):
        pawn = Pawn(owner=0, pawn_id=0, zone=Zone.MAIN, index=1)
        path = self.board.get_path_backward(pawn, steps=3)
